...
3. Give the bot a handle (ex: `meetingAppBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://idjaosijdasidjasd.ngrok.io/api/messages`
