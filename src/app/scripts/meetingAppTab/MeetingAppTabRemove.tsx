...
export interface IMeetingAppTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IMeetingAppTabRemoveProps {

}

/**
 * Implementation of Meeting App Tab remove page
 */
export class MeetingAppTabRemove  extends TeamsBaseComponent<IMeetingAppTabRemoveProps, IMeetingAppTabRemoveState> {
